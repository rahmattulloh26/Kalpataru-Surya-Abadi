        ...
        <div class= " py-3 md:py-2 lg:py-4 xl:py-0 px-10 md:px-25 lg:px-10 md:pl-15 xl:pl-50 ">
            <div class="container mx-auto flex items-center justify-between ">
                ...
                <nav id="nav-menu"
                    ...
                    <ul
                        class="block lg:flex lg:ml-20 xl:w-full xl:justify-center xl:items-center ">
                        <li>
                ...
                <div class="flex items-center space-x-3">
                    <div class="hidden  xl:flex  md:pr-16  xl:pr-50   items-center space-x-3">
                        <a href="https://wa.me/{{ config('app.contact_phone') }}?text={{ urlencode('Halo Jongveksi, saya ingin menanyakan perihal produk Anda.') }}"
